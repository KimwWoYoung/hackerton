...
투자에 관심이 높아짐에 따라 예적금보다 상대적으로 위험도가 높은 주식 투자에도 개인의 관심도가 증가하고 있다. 일반적으로 투자한 기업의 주가의 상승과 하락에 따라 자산이 증감하게 된다. 따라서 주식투자를 통해 수익을 내기 위해선 기업의 주가를 예측해야 된다. 그 방법으로 여러 가지가 있지만, 이 프로젝트는 네이버 사이트를 통해 다양한 신문사의 뉴스 기사를 수집하고, 그 기사들이 주가에 어떤 영향을 주는지 분석하여 주가를 예측하고자 한다.
